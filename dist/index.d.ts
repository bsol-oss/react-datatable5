 ...
 */
declare const validateData: (data: unknown, schema: JSONSchema7) => ValidationResult;
/**
 ...
 */
declare const createSchemaValidator: (schema: JSONSchema7) => (data: unknown) => ValidationResult;
