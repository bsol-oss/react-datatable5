...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'IdPicker with comprehensive i18n support using the useFormI18n hook',
      },
    },
  },
  argTypes: {},
    ...
    resources: {
      en: {
        translation: {
          ...
          "single_user.empty_search_result": "No users found matching your search",
...
const mockUsers = [
  { id: "user-1", name: "Alice Chen", email: "alice@example.com", department: "Engineering" },
  { id: "user-2", name: "Bob Wong", email: "bob@example.com", department: "Design" },
  { id: "user-3", name: "Charlie Lee", email: "charlie@example.com", department: "Marketing" },
  { id: "user-4", name: "Diana Ng", email: "diana@example.com", department: "Sales" },
  { id: "user-5", name: "Edward Lam", email: "edward@example.com", department: "Engineering" },
  { id: "user-6", name: "Fiona Chow", email: "fiona@example.com", department: "HR" },
  { id: "user-7", name: "George Tsang", email: "george@example.com", department: "Finance" },
  { id: "user-8", name: "Helen Ma", email: "helen@example.com", department: "Operations" },
];

// Custom query function to simulate API calls
const customUserQueryFn = async ({ searching, limit, offset }: CustomQueryFnParams) => {
...
const IdPickerForm = () => {
  ...
  return (
    <Flex direction="column" gap={4} p={4}>
      ...
      >
        <Heading size="md">
          IdPicker with useFormI18n Hook
        </Heading>
        <Text fontSize="sm" color="gray.600">
          This story demonstrates the simpler i18n pattern using the useFormI18n hook.
          Switch languages to see all translations in action.
        </Text>

        <Flex gap={2} alignItems="center">
          <Text fontSize="sm" fontWeight="bold">Language:</Text>
          <Button
            size="sm"
        ...
        {/* Code comparison */}
        <Flex direction="column" gap={2} mt={2} p={3} bg="white" borderRadius="md">
          <Text fontSize="xs" fontWeight="bold">Old Pattern (Verbose):</Text>
          <Text fontSize="xs" fontFamily="mono" color="red.600">
            {`translate.t(removeIndex(removeIndex(\`\${column}.field_label\`)))`}
          </Text>
          <Text fontSize="xs" fontWeight="bold" mt={2}>New Pattern (Clean):</Text>
      ...
      >
        ...
        <Flex direction="column" gap={1} mt={2} fontFamily="mono" fontSize="xs">
          <Text>• <strong>formI18n.label()</strong> → field_label</Text>
          <Text>• <strong>formI18n.required()</strong> → field_required</Text>
          <Text>• <strong>formI18n.t('undefined')</strong> → undefined</Text>
          <Text>• <strong>formI18n.t('add_more')</strong> → add_more</Text>
          <Text>• <strong>formI18n.t('type_to_search')</strong> → type_to_search</Text>
          <Text>• <strong>formI18n.t('total')</strong> → total</Text>
          <Text>• <strong>formI18n.t('showing')</strong> → showing</Text>
          <Text>• <strong>formI18n.t('per_page')</strong> → per_page</Text>
          <Text>• <strong>formI18n.t('empty_search_result')</strong> → empty_search_result</Text>
          <Text>• <strong>formI18n.t('initial_results')</strong> → initial_results</Text>
        </Flex>
      </Flex>
    </Flex>
  );
